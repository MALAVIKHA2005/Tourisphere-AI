...
const buildTrendChartData = (trend) => {
  ...
  // 3-year series is too dense to read in a compact modal chart.
        ...
        <div className="p-6">
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between mb-3">
              ...
              {interestTrend?.available && interestTrend.medianYoyGrowthPercent !== null && (
                <span className="text-xs font-semibold text-gray-500">
                  {interestTrend.medianYoyGrowthPercent > 0 ? "↑" : "↓"}{" "}
                  {Math.abs(interestTrend.medianYoyGrowthPercent)}% YoY
                </span>
              )}
            </div>
            ...
            {loadingInterestTrend && (
              <p className="text-sm text-gray-500">Loading trend...</p>
            )}

            {!loadingInterestTrend && !interestTrend?.available && (
              <p className="text-sm text-gray-500">No data available for this place.</p>
            )}

            {!loadingInterestTrend &&
              interestTrend?.available &&
              interestTrend.historical.length === 0 && (
            ...
            {!loadingInterestTrend &&
              ...
              interestTrend.historical.length > 0 && (
                <div className="h-48">
                  <Line
                    data={buildTrendChartData(interestTrend)}
