...
- AI Trip Planner: a real day-by-day itinerary generator (same Groq setup as the AI Assistant) built from this platform's own real nearby restaurants, live hotels and lifestyle spots for the chosen destination -- never invents a place name; honestly says so when there isn't enough real data to fill a day rather than padding with filler
